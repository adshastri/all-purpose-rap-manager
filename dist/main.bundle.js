...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.songsService.getApprovedSongs().then(function (data) { _this.dels = data; console.log(data); }).catch(function (err) { return console.log(err); });
        this.refreshState();
    };
